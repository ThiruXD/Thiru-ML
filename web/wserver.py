...
<body>
  <!--© Designed and coded by @ThiruEmpire-->
    <header>
      <div class="brand">
        <img
          ...
          alt="logo"
        />
        <a href="https://telegram.me/ThiruEmpire">
          <h2 class="name">Bittorrent Selection</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://telegram.me/ThiruEmpire"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <div id="sticks">
...
<body>
    ...
    <div class="content">
        ...
        <a href="https://telegram.me/ThiruEmpire" style="text-decoration: none;">
            <button class="button">Join Updates Channel Now</button>
        </a>
    </div>
    <div class="footer">
© 2023-24 ThiruEmpire. All Rights Reserved.
    </div>
</body>
</html>
"""
